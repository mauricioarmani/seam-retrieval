...
class VSE(object): # NOVO
    ...
    def load_state_dict(self, state_dict, state_dict_2):
        ...
        self.txt_enc_2.load_state_dict(state_dict_2) # se resume2 for .pth
    ...
    def forward_emb(self, images, captions, lengths, volatile=False):
        ...
        if self.epoch <= 10:
            trade = self.epoch/20.
            acap_emb = trade*cap_emb + (1. - trade)*cap_emb_2
        if self.epoch > 10:
            acap_emb = 0.5*cap_emb + 0.5*cap_emb_2

        return img_emb, acap_emb
